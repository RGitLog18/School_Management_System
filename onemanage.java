...
class One1 extends JFrame {
    ...
    One1() {
        ...
        JLabel title = new JLabel("1st STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRendererone());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditorone(tableModel, table));
...
//        bottomPanel.setBackground(new Color(220, 48, 220));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM oneth_std";
...
// Button Renderer
class ButtonRendererone extends JButton implements TableCellRenderer {
    public ButtonRendererone() {
        setText("Check");
...
// Button Editor
class ButtonEditorone extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditorone(DefaultTableModel model, JTable table) {
