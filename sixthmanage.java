...
class Six1 extends JFrame {
    ...
    Six1() {
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRenderersix());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditorsix(tableModel, table));
...
//        bottomPanel.setBackground(new Color(220, 48, 220));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM sixth_std";
...
// Button Renderer
class ButtonRenderersix extends JButton implements TableCellRenderer {
    public ButtonRenderersix() {
        setText("Check");
...
// Button Editor
class ButtonEditorsix extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditorsix(DefaultTableModel model, JTable table) {
