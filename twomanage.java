...
class Two1 extends JFrame {
    ...
    Two1() {
        ...
        JLabel title = new JLabel("2nd STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRenderertwo());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditortwo(tableModel, table));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM twoth_std";
        ...
        setTitle("Second Standard Fee Details");
        setSize(1200, 600);
...
// Button Renderer
class ButtonRenderertwo extends JButton implements TableCellRenderer {
    public ButtonRenderertwo() {
        setText("Check");
...
// Button Editor
class ButtonEditortwo extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditortwo(DefaultTableModel model, JTable table) {
