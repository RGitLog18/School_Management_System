...
class Four1 extends JFrame {
    ...
    Four1() {
        ...
        JLabel title = new JLabel("4th STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRendererfour());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditorfour(tableModel, table));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM fourth_std";
        ...
        setTitle("Fourth Standard Fee Details");
        setSize(1200, 600);
...
class ButtonEditorfour extends DefaultCellEditor {
    ...
    public ButtonEditorfour(DefaultTableModel model, JTable table) {
