...
class student_feedetails1 extends JFrame {
    student_feedetails1(String name,String Class, int phone) {
...
//                        String sql = "Select * from fee_details where fees_remaining between "+min+" and "+max;
...
//        );
    ...
    public static void main(String[] args) {
        new student_feedetails1("Rajshree","Eight",12345);
    }
}
