...
class Nine1 extends JFrame {
    ...
    Nine1() {
        ...
        JLabel title = new JLabel("9th STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRenderernine());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditornine(tableModel, table));
...
// Button Renderer
class ButtonRenderernine extends JButton implements TableCellRenderer {
    public ButtonRenderernine() {
        setText("Check");
...
// Button Editor
class ButtonEditornine extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditornine(DefaultTableModel model, JTable table) {
