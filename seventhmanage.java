...
class Seventh1 extends JFrame {
    ...
    Seventh1() {
        ...
        JLabel title = new JLabel("7th STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRendererseven());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditorseven(tableModel, table));
...
//        bottomPanel.setBackground(new Color(220, 48, 220));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM seventh_std";
...
// Button Renderer
class ButtonRendererseven extends JButton implements TableCellRenderer {
    public ButtonRendererseven() {
        setText("Check");
...
// Button Editor
class ButtonEditorseven extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditorseven(DefaultTableModel model, JTable table) {
