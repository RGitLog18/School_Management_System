...
class Eight1 extends JFrame {
    ...
    Eight1() {
        ...
        JLabel title = new JLabel("8th STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRenderereight());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditoreight(tableModel, table));
...
//        bottomPanel.setBackground(new Color(220, 48, 220));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM eightth_std";
        ...
        setTitle("Eighth Standard Records");
        setSize(1200, 600);
...
// Button Renderer
class ButtonRenderereight extends JButton implements TableCellRenderer {
    public ButtonRenderereight() {
        setText("Check");
...
// Button Editor
class ButtonEditoreight extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditoreight(DefaultTableModel model, JTable table) {
...
//    private void openFeeDetailsPage(int row) {
//        String name = model.getValueAt(row, 0).toString();
//        String contact = model.getValueAt(row, 2).toString();
//        String email = model.getValueAt(row, 3).toString();
//        new FeeDetailsPage(name, contact, email);
//    }
//}

// Fee Details Page
//class FeeDetailsPage extends JFrame {
//    FeeDetailsPage(String name, String contact, String email) {
...
//        JLabel label2 = new JLabel("Contact: " + contact);
//        JLabel label3 = new JLabel("Email: " + email);
//
