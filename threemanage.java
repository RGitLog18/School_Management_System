...
class Three1 extends JFrame {
    ...
    Three1() {
        ...
        JLabel title = new JLabel("3rd STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRendererthree());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditorthree(tableModel, table));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM threeth_std";
        ...
        setTitle("Third Standard Fee Details");
        setSize(1200, 600);
...
// Button Renderer
class ButtonRendererthree extends JButton implements TableCellRenderer {
    public ButtonRendererthree() {
        setText("Check");
...
// Button Editor
class ButtonEditorthree extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditorthree(DefaultTableModel model, JTable table) {
