...
class Fifth1 extends JFrame {
    ...
    Fifth1() {
        ...
        JLabel title = new JLabel("5th STD", JLabel.CENTER);
        ...
        table.getColumn("Fee Details").setCellRenderer(new ButtonRendererfifth());
        table.getColumn("Fee Details").setCellEditor(new ButtonEditorfifth(tableModel, table));
        ...
        try (Connection con = DriverManager.getConnection(url, "root", "R1a2j3#*")) {
            String sql = "SELECT * FROM fiveth_std";
        ...
        setTitle("Fifth Standard Fee Details");
        setSize(1200, 600);
...
// Button Renderer
class ButtonRendererfifth extends JButton implements TableCellRenderer {
    public ButtonRendererfifth() {
        setText("Check");
...
// Button Editor
class ButtonEditorfifth extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private DefaultTableModel model;
    private int selectedRow;

    public ButtonEditorfifth(DefaultTableModel model, JTable table) {
